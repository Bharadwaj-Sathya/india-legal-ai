...
def ingest_documents():
    ...
    try:
        ...
        for pdf_path in pdf_files:
            ...
            print(
                f"Legal sections/pages produced: {len(sections)}"
            )
        ...
        if not documents:
            ...
            raise HTTPException(
                status_code=500,
                detail="No documents were produced after parsing.",
            )
        ...
        print(
            f"\nTotal parsed documents: {len(documents)}"
        )
...
def debug_section(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail=f"Section debug failed: {str(exc)}",
        )